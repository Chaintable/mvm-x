...
This repository is a **fork**: upstream [ethereum-optimism/optimism](https://github.com/ethereum-optimism/optimism)
...
a general-purpose fork of ethereum-optimism/optimism.
...
* Release tags follow `v<base-version>-ct.N` (`ct` = Chaintable; e.g.
  `v0.3.7-ct.11`); a GitHub Release publishes the versioned images
...
terms as this repository — see [LICENSE](./LICENSE) (MIT).
